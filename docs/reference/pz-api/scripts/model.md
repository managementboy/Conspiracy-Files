...
<a id="scripts-model"></a>

# model

**Soft Override:** Unknown

Used to define a model properties so it can be used in other elements of the game, most notably in [items](item.md) and [vehicles](vehicle.md). The basic structure of a model block is as follows:
...
[Attachments](attachment.md) blocks can also be added to the model definition to specify how the model should be placed, rotated and scaled when attached to a parent model.
...
**No ID for parents:** [vehicle](vehicle.md#scripts-vehicle)

<a id="parameters"></a>

## Parameters

<a id="scripts-model-animationsmesh"></a>

### animationsMesh

**Type:** block (block: [animationsMesh](animationsmesh.md#scripts-animationsmesh), with [module](module.md#scripts-module))

Sets the [animations mesh](animationsmesh.md) for the model. This is used for models that are used for entities such as the character or animals.

<a id="scripts-model-attachmentparent"></a>
...
<a id="scripts-model-attachmentself"></a>
...
<a id="scripts-model-boneweight"></a>
...
<a id="scripts-model-colorblue"></a>
...
<a id="scripts-model-colorgreen"></a>
...
<a id="scripts-model-file"></a>

### file

**Type:** block (block: [model](model.md#scripts-model))

Points to a [model](model.md) block to use as the vehicle model.

<a id="scripts-model-ignorevehiclescale"></a>
...
<a id="scripts-model-mesh"></a>

### mesh

**Type:** Unknown

Path to the model file relative to the `media/models_X` folder. The model file can be either of `.fbx` or `.glb` but also the not recommended `.x` (read more [here](../../pzwiki/assets-and-animation/Modeling.md)). The extension should not be included in the value of this parameter.
...
<a id="scripts-model-specialkeyring"></a>
...
<a id="scripts-model-undocorescale"></a>
