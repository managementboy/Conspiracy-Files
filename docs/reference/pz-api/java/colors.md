...
Available colors accessible from Lua code or usable inside Scripts. Custom colors can be defined with the [colors](../scripts/colors.md) block.

<a id="id2"></a>

Colors

| Name | Field | RGB Hex | Scripts Usage |
| --- | --- | --- | --- |
