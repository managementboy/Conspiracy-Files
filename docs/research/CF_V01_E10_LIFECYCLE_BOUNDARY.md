...
The smallest v0.1 boundary adds no death record and no recap state. Canonical
...
The deterministic death recap is deliberately omitted from base v0.1. This
...
No recap, death UI, physical item/corpse reconciliation, placement, arrival,
