...
`PZ_VEHICLE_AREAS_AND_ZONES.md` (2026-09-15) records where a player must stand to use each part of a vehicle - the `area` boxes, the pickup van's real numbers, the game's truck-bed rule and a probe of it - and the map zones vehicles spawn in, extracted once from PZwiki and checked against the installed 42.20.4 game.
