...
2. Stay inside briefly while metadata/storage loading completes. Search furniture for the opening mixed-evidence clue. The evidence toolbar button should initialize automatically. No closer zoom or console command needed.
