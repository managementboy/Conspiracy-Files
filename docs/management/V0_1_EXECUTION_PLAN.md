...
T11 and T12 may run in parallel after a usable binding is available. T12 may begin earlier with synthetic display data, but its final verdict must be checked against the production-intended interaction path.

## Unattended work

- maintain the milestone, issues, dependencies and acceptance traceability;
- prepare probe code, static tests, deterministic fault controls and evidence templates;
- review installed Build 42 Lua APIs read-only and record every assumed API in the probe report;
- prepare decision diffs where the owner has already approved the outcome;
- review the Dead Air text and produce a bounded approval/change sheet;
- prepare production patches that remain explicitly conditional on unperformed live checks.

## Attendance-required work

- manual P2/R2 route, room, floor and boundary validation;
- T10-derived context-menu activation and coexistence checks under P4-R44;
- visual, focus, controller, scaling and usability judgment for T12;
...
- exact P2/R2 bindings are committed and CF-V01-E01 passes;
- the Dead Air human content gate is closed;
- T11 has a recorded live verdict and no unresolved composition blocker;
- T12 has a recorded live verdict and the UI specification reflects its limitations;
- all owner decisions above are reflected in `DECISIONS.md` and dependent requirements;
- Issue #31 has a bounded implementation checklist with no graph, theory, AI, content-pack, retrofit, migration or multiplayer-support expansion.
