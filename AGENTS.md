...
Linux handoff. The candidate remains unvalidated; Git delivery uses `origin/main`. Claude retains
...
- **Owner decisions 2026-09-11 (P4-R69 to P4-R76 in DECISIONS.md):** commit finished, verified work without asking; record every owner decision in DECISIONS.md; the Linux PC is dedicated to this mod. Weekend autonomy: work through docs/management/TEST_CATALOGUE.md without waiting for confirmation, fix defects and re-test (design/tone questions go to the owner), push verified batches straight to main (P4-R117, 2026-09-15, replaces the integration-branch rule of P4-R75; tag each Workshop build), publish builds that pass the Linux boot check to the unlisted Workshop item.
