...
check("mark intent creates once and disables later menu activation",
    test.domain.markCalls == 1 and test.domain.marked["token:key"] == true and marked.notAvailable and marked.onSelect == nil)
...
print("PASS summary: 16 static T10 probe checks")
