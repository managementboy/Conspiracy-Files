...
class OwnerPhaseLifecycleTests(unittest.TestCase):
    ...
    def test_actual_lua_probe_replay_drives_hold_release_and_timeout(self):
        ...
        for mode in ("hold", "release", "root-invisible", "lease-stale", "timeout", "malformed", "foreign", "stale", "duplicate", "pre-ready", "partial", "restart", "future", "missing-error", "read-error"):
