...
Checked against the intake cards by {P2}.]],
   ...
   findings={
    ...
    "The serial checks confirm the exchange the radio's wrong tag implied, and the owners sign for their own sets.",
...
Please do not adjust mine to match. Your last adjustment took two visits.]],
  ...
  scenario{
   ...
   extraFindings={{requires={"response","parts-card"},from="parts-card",to="response",kind="corroborates",
    text="The supplier's card sits with the saw whose teeth were never touched."}},
 ...
 ["paid-before-ordered"]={
  scenario{
   ...
   extraFindings={{requires={"response","own-card"},from="own-card",to="response",kind="corroborates",
    text="The card names the worker whose own money paid for the shingles stacked in the yard."}},
 ...
 ["overtime-nobody-worked"]={
  scenario{
   ...
   extraFindings={{requires={"response","gate-pass"},from="gate-pass",to="response",kind="corroborates",
    text="The gate card belongs to the worker whose shift ran behind a padlock nobody opened."}},
...
Standby plant inspected by {P2}.]],
   ...
   findings={
    ...
    "The reopening reply accepts the fuelled generator as maintenance but refuses admission, distinguishing finished preparation from an unfinished safety review.",
