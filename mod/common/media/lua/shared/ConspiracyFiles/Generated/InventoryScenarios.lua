...
Original return remains filed as submitted. Do not amend the target report without a supervisor's authorisation.]],
   ...
   findings={
    ...
    "The correction accepts the linen and scissors as storage and removes 14 from guest occupancy, but leaves the original target report awaiting authorisation.",
...
Drop-box receipts remain available at the counter during opening hours.]],
   ...
   findings={
    ...
    "The key log corroborates the re-keyed padlock, then orders a refund from the departure date.",
...
No further purchases to be entered against a dismantled vehicle.]],
   ...
   findings={
    ...
    "The issue check matches the quantity in the generator's log and corroborates {P2}'s instruction, then closes the borrowed account again.",
