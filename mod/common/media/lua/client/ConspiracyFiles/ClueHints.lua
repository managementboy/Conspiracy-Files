...
-- The halo wonders; the bubble states (swapped round, 2026-09-14). Handing both the same sentence is what
...
local function announce(p,text)
    ...
    -- The phrase in white, the fact in the coloured bubble (owner, Windows,
    -- 2026-09-14); with no halo at all the phrase still shows, in the bubble.
    p:Say(halo and HINT_HALO or text)
    local audible=false
