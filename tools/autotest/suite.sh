...
checks=(boot_check.sh checks/clue_search.sh checks/clue_actions.sh checks/wallet_id.sh checks/core_loop.sh checks/drop_note.sh checks/case_body.sh checks/vehicle_reach.sh checks/reload.sh
