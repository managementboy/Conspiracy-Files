...
checks=(boot_check.sh checks/wallet_id.sh checks/core_loop.sh checks/reload.sh checks/death.sh checks/faults.sh checks/perf.sh checks/knox.sh checks/reshuffle.sh)
pass=0; total=0
for c in "${checks[@]}"; do
