...
assert(#Premises.list()==24,"the metadata registry has all twenty-four authored families")
...
assert(covered==48,"every authored family variant supplies saved readings")
