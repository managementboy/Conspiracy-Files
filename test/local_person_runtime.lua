...
local s=assert(R.bindVisible(L.empty(),{caseId="c",buildingId="b",sourceToken="corpse:1",name="Dana",keyToken="key:1",keyId=7}));assert(s.records.c.assignedOccupation=="electrician")
